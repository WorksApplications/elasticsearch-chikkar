...
public class AnalysisChikkarPluginTest {
    ...
    private TokenFilterFactory tokenFilterA; // for user A
    private TokenFilterFactory tokenFilterB; // for user B
    private TokenFilterFactory tokenFilterC; // for user C
    private TokenFilterFactory tokenFilterD; // for user D
    ...
    TokenFilterFactory createUserTokenFilterFactory(Path configPath, List<String> dictList, TokenizerFactory tokenizer)
        ...
        Settings settings = Settings.builder().put("version", "8.0.0").putArray("dict_list", dictList)
    ...
    @Test
    public void testGetSingleTokenSynonymsInUserA() throws Exception {
        /*
        ...
        List<TokenAttribute> result = parseSynonyms(tokenFilterA, query);
        ...
        expected = Arrays.asList(new TokenAttribute("曖昧", "SYNONYM", 0, 0, 3, 1),
                ...
                new TokenAttribute("あいまい", "SYNONYM", 0, 0, 3, 1));
        Collections.sort(expected);
        result = parseSynonyms(tokenFilterA, query);
        Collections.sort(result);
        assertSynonymsEquals(expected, result);
        ...
        expected = Arrays.asList(new TokenAttribute("曖昧", "SYNONYM", 0, 0, 4, 1),
                ...
                new TokenAttribute("あいまい", "SYNONYM", 0, 0, 4, 1));
        Collections.sort(expected);
        result = parseSynonyms(tokenFilterA, query);
        Collections.sort(result);
        assertSynonymsEquals(expected, result);
        ...
        query = "あいまい";
        expected = Arrays.asList(new TokenAttribute("曖昧", "SYNONYM", 0, 0, 4, 1),
                new TokenAttribute("不明確", "SYNONYM", 0, 0, 4, 1), new TokenAttribute("あやふや", "SYNONYM", 0, 0, 4, 1),
    ...
    @Test
    public void testGetSingleTokenSynonymsInUserB() throws Exception {
        /*
        ...
        List<TokenAttribute> expected = Arrays.asList(new TokenAttribute("曖昧", "word", 0, 0, 2, 1),
                new TokenAttribute("不明確", "SYNONYM", 0, 0, 2, 1), new TokenAttribute("あやふや", "SYNONYM", 0, 0, 2, 1));
        Collections.sort(expected);
        List<TokenAttribute> result = parseSynonyms(tokenFilterB, query);
        Collections.sort(result);
        assertSynonymsEquals(expected, result);
        ...
        expected = Arrays.asList(new TokenAttribute("曖昧", "SYNONYM", 0, 0, 3, 1),
                new TokenAttribute("不明確", "word", 0, 0, 3, 1), new TokenAttribute("あやふや", "SYNONYM", 0, 0, 3, 1));
        Collections.sort(expected);
        result = parseSynonyms(tokenFilterB, query);
        Collections.sort(result);
        assertSynonymsEquals(expected, result);
    ...
    @Test
    public void testGetSingleTokenSynonymsInUserC() throws Exception {
        /*
         * 概要,大要,要約,要旨,梗概
         *
         * All words without space inside will be treated as single-token synonym as the
        ...
        Collections.sort(expected);
        List<TokenAttribute> result = parseSynonyms(tokenFilterC, query);
        Collections.sort(result);
        assertSynonymsEquals(expected, result);
        ...
        expected = Arrays.asList(new TokenAttribute("概要", "SYNONYM", 0, 0, 2, 1),
                ...
                new TokenAttribute("要旨", "SYNONYM", 0, 0, 2, 1), new TokenAttribute("梗概", "SYNONYM", 0, 0, 2, 1));
        Collections.sort(expected);
        result = parseSynonyms(tokenFilterC, query);
        Collections.sort(result);
        assertSynonymsEquals(expected, result);
    ...
    @Test
    public void testGetMultiTokenSynonyms() throws Exception {
        /*
        ...
        Collections.sort(expected);
        List<TokenAttribute> result = parseSynonyms(tokenFilterD, query);
        Collections.sort(result);
        assertSynonymsEquals(expected, result);
        ...
        Collections.sort(expected);
        result = parseSynonyms(tokenFilterD, query);
        Collections.sort(result);
        assertSynonymsEquals(expected, result);
